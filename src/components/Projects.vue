    ...
    return {
      projects: [
        // в планах вынести все проекты в отдельный файл, но пока что так
        {
          ...
          icon: '../../public/assets/icons/list3.svg',
        ...
        },
        {
          ...
          icon: '../../public/assets/icons/portfolio-icon.svg',
        ...
        },
        {
          ...
          icon: '../../public/assets/icons/timer-icon.svg',
          link: '',
          showDetails: false
        },
        {
          ...
          icon: '../../public/assets/icons/weather-icon.svg',
          link: '',
          showDetails: false
        },
        {
          ...
          icon: '../../public/assets/icons/landing-icon.svg',
