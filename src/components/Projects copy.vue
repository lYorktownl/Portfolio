...
<template>
  ...
  >
    <div class="p-[10px] sm:m-[10px] m-[10px] sm:flex   mb-4 bg-[#292f36fa] rounded-xl" :class="{ 'flex-col': !showDetails, 'min-w-full': showDetails }">
      <div class="sm:min-w-48 sm:h-48 w-28 h-28 flex flex-col justify-center items-center mx-auto">
        ...
        <h3 class="text-center">Kanban desk</h3>
        <a href="https://github.com/lYorktownl/My_kanban.git" target="_blank" class="border-b-2 hover:text-teal-500">
          View on github
        </a>
      </div>
...
import list3Icon from '@/assets/icons/list3.svg';
